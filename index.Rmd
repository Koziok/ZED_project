...
Raport zawiera analize zbioru danych z bazy Rebrickable, która obejmuje informacje o klockach Lego. W sekcji [Wstęp](#intro) ładowane są wykorzystane biblioteki, zbiory danych oraz przedstawiona jest zawartośc każdej tabeli. Sekcja [Analiza](#analysis) podzielona jest na 4 podsekcje przedstawiające analizy ogólne, analizy zapasów Rebrickable, trendy na przestrzeni lat i korelacje pomiędzy wybranymi cechami zbioru. Ostatnia sekcja, [Predykcja](#prediction), zawiera próbę przewidzenia trendu wybranych cech dla przyszłych 10 lat.

Spostrzeżenia:

* najpopularnijeszymi kolorami klocków Lego są czarny i biały,
...
* mean_parts - średnia liczba części
